...
```json
{"schema":"elyra.ai-context.v2","updated":"2026-09-14","current_milestone":"M3_MEASUREMENT_IN_PROGRESS","next_milestone":"M3_THRESHOLD_CALIBRATION","windows_status":"PAUSED_AT_W1","linux_status":"L7_COMPLETE_NATIVE_EVIDENCE_HOST_DEPENDENT","cloud_allowed":false,"trained_model_available":false,"llm_analyst_available":false,"last_commit":"9c16800","last_validation":"signature/yara/authenticode: 11 passed; pe evidence: 59 passed, 1 skipped; dataset/metrics tests pending user run","m2_completed":["provenance-aware local rule bundle schema","bounded YARA-X adapter","bounded PE directory and packer evidence","honest Authenticode report","signature parser resource/fuzz safety"],"m3_completed":["deterministic local evaluation metrics","leakage-resistant dataset manifest validation"]}
```
