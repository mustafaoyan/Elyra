...
| GUI settings were stored in the current directory | `gui/view.py:145-166` | Medium | Installed GUI could write unpredictable files | Settings use `$XDG_CONFIG_HOME/elliot/gui.json`, mode `0600`, atomic replacement |
