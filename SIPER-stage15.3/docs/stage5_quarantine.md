...
`src/elliot/response/quarantine_manager.py`
...
- `/var/lib/elliot/quarantine/`
- `/var/lib/elliot/metadata/`
...
If a recoverable operation fails before commit, ELLIOT restores the holding file to the
...
- Any existing file, directory or symbolic link at the destination causes a conflict;
  ELLIOT never silently overwrites it.
