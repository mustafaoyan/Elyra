#!/usr/bin/env python3
"""Create a reproducible local ELLIOT Windows executable and installer.
...
def main(argv: list[str] | None = None) -> int:
    ...
    entrypoint = PROJECT_ROOT / "packaging" / "windows" / "elliot_gui.py"
    _run(
        [
            pyinstaller,
            "--noconfirm",
    ...
    template = (PROJECT_ROOT / "packaging" / "windows" / "ELLIOT.iss").read_text(encoding="utf-8")
    generated = build_root / "ELLIOT.generated.iss"
    ...
    installer = installer_dist / f"ELLIOT-Setup-{args.version}-x64.exe"
