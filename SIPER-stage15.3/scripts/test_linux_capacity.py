#!/usr/bin/env python3
"""Run ELLIOT's safe Linux capacity contract and write assertion evidence.
...
from elliot.analyzer.entropy import EntropyEngine
from elliot.monitor.ebpf.kernel_headers import (
    VirtualizationInfo,
...
def run_portable_assertions() -> list[AssertionResult]:
    ...
    with tempfile.TemporaryDirectory(prefix="elliot-capacity-") as directory:
        root = Path(directory)
