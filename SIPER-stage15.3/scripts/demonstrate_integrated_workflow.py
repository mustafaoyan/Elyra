...
from elliot.service.install_layout import write_json_atomic
...
def main(argv: list[str] | None = None) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="elliot-stage14-integrated-") as temporary:
        root = Path(temporary)
        work = root / "work"
        ...
        executable = work / "elliot-stage14-safe-sleep"
