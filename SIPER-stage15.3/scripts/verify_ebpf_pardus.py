...
from elliot.monitor.ebpf.collector import EbpfFilterConfig
from elliot.monitor.ebpf.loader import EBPFLoader
...
def main() -> int:
    ...
    if not loader.initialize():
        ...
        return 2
    try:
        with tempfile.TemporaryDirectory(prefix="elliot-stage9-") as temp:
            root = Path(temp)
