"""Deterministic release-archive helpers for Siper (ELLIOT project)."""
...
def build_release_artifacts(project_root: Path, output_dir: Path) -> list[Path]:
    ...
    source_zip = output_dir / f"siper-pardus-{version}-source.zip"
    submission_zip = output_dir / f"SIPER-Pardus-{version}-submission.zip"
