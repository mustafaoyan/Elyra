...
logger = logging.getLogger("elliot.monitor.fanotify.controller")
...
class FanotifyController:
    def __init__(
        ...
        *,
        ...
        self.event_executor = ThreadPoolExecutor(
            ...
            thread_name_prefix="ElliotFanotifyEvent",
        )
    ...
    def _evaluate_event(
        ...
        if event.pid == self.daemon_pid or (
            ...
            return "ALLOW", "ELLIOT_PROCESS_EXCLUDED", {}
        if self.policy.is_excluded_path(event.path):
            return "ALLOW", "ELLIOT_OR_SYSTEM_PATH_EXCLUDED", {}
