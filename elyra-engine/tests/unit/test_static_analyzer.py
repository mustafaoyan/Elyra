...
from elyra.analyzer.entropy import EntropyConfig, FileAccessError
from elyra.analyzer.static_analyzer import StaticAnalyzerConfig, StaticFileScanner
...
def test_ordinary_text_and_compressed_file(tmp_path: Path) -> None:
    ...
    content = ("Pardus ELYRA test data\n" * 100).encode()
