...
from elyra.gui.view import ElyraView
...
def make_view():
    ...
    view = SimpleNamespace(
        COLORS=ElyraView.COLORS, _risk_animation_job="previous-animation",
...
def test_inconclusive_scan_cancels_stale_animation_and_displays_na():
    ...
    ElyraView.render_scan_result(view, {
    ...
    assert view.risk_number_label.options == {"text": "N/A", "text_color": ElyraView.COLORS["muted"]}
