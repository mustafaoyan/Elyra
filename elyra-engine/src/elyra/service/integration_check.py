...
The verifier exercises the installed Elyra daemon in its production-safe
...
def collect_integrated_workflow_report(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="elyra-stage14-live-") as temporary:
        fixture_dir = Path(temporary)
        executable = fixture_dir / "elyra-stage14-safe-sleep"
