...
logger = logging.getLogger("elyra.quarantine")

QUARANTINE_DIR = "/var/lib/elyra/quarantine"
METADATA_DIR = "/var/lib/elyra/metadata"
    ...
    def quarantine_file(
        ...
        *,
        ...
        try:
            ...
            holding_path = source_path.parent / f".elyra-{quarantine_id}.pending"
