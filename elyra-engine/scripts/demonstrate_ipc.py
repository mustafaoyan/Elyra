...
from elyra.service.authorization import AuthorizationError, Requester, authorize
from elyra.service.ipc_client import IpcClient
from elyra.service.ipc_protocol import MAX_REQUEST_BYTES, PROTOCOL_VERSION
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="elyra-stage6-") as directory:
        socket_path = Path(directory) / "run" / "elyra.sock"
