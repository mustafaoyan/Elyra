...
from elyra.gui.view import PardusView
...
def main() -> None:
    with tempfile.TemporaryDirectory(prefix="elyra-stage7-visual-") as temporary:
        socket_path = Path(temporary) / "run" / "elyra.sock"
